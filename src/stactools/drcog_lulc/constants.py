...
ASSET_PROPS: Dict[str, Any] = {
    "data": {
        ...
        "DRCOG LULC",
        "description":
        "Denver Regional Council of Governments (DRCOG) Land Use Land Cover (LULC) classifications",  # noqa
        "roles": ["data"],
        "bands": [{
...
PROVIDERS = [
    Provider(name="DRCOG",
             roles=[
                 ...
                 ProviderRole.HOST,ProviderRole.PROCESSOR
             ],
             url="https://drcog.org/services-and-resources/data-maps-and-modeling/regional-land-use-land-cover-project")
]
EXTENT = Extent(SpatialExtent([[-104.867784, -104.641093, 39.667712, 39.549871]]),
...
REPORT_LINK = Link(
    rel="describedby",
    target=  # noqa
    "https://gis.drcog.org//rdc/supplemental/lulc_pilot_report.zip",
